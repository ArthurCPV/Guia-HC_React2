...
function MenuComponent() {
  return (
    <div id="menu" className="w-full md:w-[80%] max-w-[660px] flex flex-col items-center py-6 pt-3 ml-auto mr-auto">
      <div className="p-4 pb-0 text-center md:text-center">
