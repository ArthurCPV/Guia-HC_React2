...
export default function FaqList({ data = DEFAULT_FAQ, allowMultiple = true }: Props) {
  ...
  return (
  <section id="corpo_pagina_faq" className="w-full flex flex-col items-center py-12 px-4">
    <div className="titulo_faq w-full max-w-6xl text-center mb-12">
      <h1 className="text-4xl md:text-5xl text-white underline decoration-blue-600/70">Perguntas frequentes</h1>
    </div>
